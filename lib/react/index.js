...
var _finish = require('./img/finish.png');

var _finish2 = _interopRequireDefault(_finish);

var _greenFlag = require('./img/greenFlag.png');
  ...
  _createClass(Marker, [{
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: style,
        ...
        onMouseOut: this.handleMouseOut }, _infact.React.createElement('div', null, _infact.React.createElement('div', { style: stepLabel }, this.props.label), _infact.React.createElement('img', { src: this.image(), style: pinMarker, alt: '' })));
    }
  }]);
