  ...
  _createClass(Marker, [{
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: style,
        ...
        onMouseOut: this.handleMouseOut }, _infact.React.createElement('div', null, 1 && _infact.React.createElement('div', { style: hoverStyle }, ' ', this.props.hoverText, ' '), _infact.React.createElement('div', { style: stepLabel }, this.props.label), _infact.React.createElement('img', { src: this.image(), style: pinMarker, alt: '' })));
    }
  }]);
