  ...
  _createClass(Marker, [{
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: style,
        ...
        onMouseOut: this.handleMouseOut }, _infact.React.createElement('div', { style: numberCircle }, '1'), _infact.React.createElement('img', { src: this.image(), width: 29, height: 34, alt: '' }));
    }
  }]);
