...
var _location = require('./img/location.svg');
  ...
  _createClass(Marker, [{
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: style,
        ...
        onMouseOut: this.handleMouseOut }, _infact.React.createElement('div', null, this.state.hover && _infact.React.createElement('div', { style: hoverStyle }, ' ', this.props.hoverText, ' '), _infact.React.createElement('div', { style: stepLabel }, this.props.label), _infact.React.createElement('img', { src: this.image(), style: pinMarker, alt: '' })));
    }
  }]);
...
Marker.propTypes = {
  ...
  markerType: _propTypes2.default.string,
